...
<div class="card border-primary mt-3 animated--grow-in">
    ...
    <div class="card-body bg-gray-200">
            	<div class="col-md-12">
                <p><h4>EDIT PASSWORD SISWA</h4>
                <br></p>
            		<?= $this->session->flashdata('message') ?>
                <form action="<?= base_url('C_siswa/edit_password/').$data_diri_siswa['nis'] ?>" method="post">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" value="<?= $data_diri_siswa['nama'] ?>" name="nama" readonly>
                  </div>
                  <div class="col-md-6">
